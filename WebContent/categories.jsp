...
<!-- register modal ends -->
 ...
 <div class="list-group">
  <a href="#" onclick="getcat(0,this) " class="list-group-item list-group-item-action c-link">
    All
  </a>
    <%
           CategoriesDao dao1=new CategoriesDao(ConnectionProvider.getConnection());
       ArrayList<Categories> cat=dao1.getAllCategories();
       for(Categories c:cat){
       %>
     <a  onclick="getcat(<%=c.getCid() %>,this)" class="list-group-item list-group-item-action c-link"><%=c.getCname() %></a>
        <%} %>
</div>
 
 <br>
 <a class="btn btn-primary text-white" href="index.jsp"><i class="fa fa-home"></i>Home</a>
 </div>
  ...
  <div class="col-md-9 ">
    ...
    <div id="load-product" class="container mt-2">
    </div>   
	 ...
	 $('#reg-form').on('submit',function(event){
		 ...
		 $.ajax({
			 ...
			 success:function(data,textStatus,jqXHR){
		       ...
		       .then((value)=>{
		    	   window.location.replace("categories.jsp");  
		       });
			 },
